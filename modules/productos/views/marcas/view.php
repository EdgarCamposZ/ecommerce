    ...
    <div class="col-lg-12">
        <div class="card card-dark">
            ...
            <div class="card-body">
                <table class="table table-sm table-striped table-hover table-bordered">
                    <tr>
                        ...
                        <td width="85%"><span class="badge bg-purple"><?= $model->id_marca ?></span></td>
                    </tr>
                    <tr>
                        <td><b>Nombre: </b></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($model->imagen == NULL) { ?>
                                <img src="<?= Yii::$app->request->hostInfo ?>/marcas/no_disponible.png" width="150" />
                                <?php } else {
            ...
            <div class="card-footer">
                <?php echo Html::a('<i class="fa fa-edit"></i> Editar', ['update', 'id_marca' => $model->id_marca],
                ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'title' => 'Edit record']) ?>
                <?php echo Html::a('<i class="fa fa-undo"></i> Regresar', ['index'],
