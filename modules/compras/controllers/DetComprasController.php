...
class DetComprasController extends Controller
{
    ...
    public function actionCreate($id_compra)
    {
        ...
        if ($model->load($this->request->post())) {
            ...
            try {
                $duplicado = DetCompras::find()->where(['id_compra' => $id_compra, 'id_producto' => $model->id_producto])->one();
    ...
    }//http://ecommerce.test/index.php?r=compras%2Fdet-compras%2Fcreate&id_compra=1
    /**
