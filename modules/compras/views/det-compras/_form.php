            ...
            <div class="card-body">
                <table class="table table-sm table-striped table-hover table-bordered">
                    <tr>
                        ...
                        <td width="30%"><span class="badge bg-purple"><?= $compra->id_compra ?></span></td>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-<?= $compra->estado == 0 ? "warning" : "red"; ?>"><?= $compra->estado == 0 ? "Sin procesar" : "Procesada"; ?></span></td>
                    </tr>
                    <tr>
